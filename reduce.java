...
public class reduce {
	...
	public static void main(String[] args) {
		List<Employee> list=List.of(new Employee("sai", "sai@gmail.com", 1234567890L, "india" , 50000.0), new Employee("chiranjeevi", "chiranjeevi@gmail.com", 9087654321L,"US", 25000.0),
				...
				new Employee("satyaBratha", "satyaBratha877@gmail.com", 7890654321L, "German", 70000.0),new Employee("Twinkle", "Twinkle@gmail.com", 9977885467L, "IceLand", 150000.0),new Employee("Twinkle", "kumari.Twinkle@gmail.com", 9977885467L, "IceLand", 150000.0));
	
		// reduce is type of collect it accepts 2 parameters (object at 1st position in stream, object at Nth position in stream) and return a optional
		System.out.println(list.stream().reduce((a,b)-> new Employee(a.getName(), b.getEmail(), 0, a.getCountry(), 0)));
