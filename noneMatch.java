...
public class noneMatch {
	public static void main(String[] args) {
		...
		// it will return true if and only if list is empty or any object in the list not match the predicate
		// it will return false if and only if any all objects match predicate
		// noneMatch if all match -> return false other wise return true
		System.out.println(list.stream().noneMatch(x-> x.getSalary() %2  == 0));
	}
}
